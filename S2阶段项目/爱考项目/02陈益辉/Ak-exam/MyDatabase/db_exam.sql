...
create table t_classInfo(
	...
	g2Num int,	--班级人数
	g3Num int,	--班级人数
	cCodeId int DEFAULT 0,	--班级状态(0:禁用，1：启用)
	cRemark varchar(50)		--备注
);

INSERT INTO t_classInfo VALUES ('16GR3','高软三班','SCME',101,102,'2016-09-07',36,36,36,1,'无')
INSERT INTO t_classInfo VALUES ('16SP1','食品一班','SCME',101,102,'2016-09-07',36,36,36,1,'无')
INSERT INTO t_classInfo VALUES ('16GR1','高软一班','SCME',103,104,'2016-09-07',35,35,35,1,'无')
...
create table t_paper(
	...
	pState varchar(10) not null,	--试卷的状态(未开考、考试中、考试结束)
);
...
create table paper_class(
	...
	examDate varchar(30) not null,--开考时间
	endDate varchar(30) not null--结束时间
);
...
--在线考试--成绩查询
用户id,试卷id,试卷随机试题id.用户做题答案,得分
create table t_userScores(
usId int primary key identity(1,1),-用户成绩表主键自增
name varchar(20),--用户名字--id
pId int,--试卷id
qids varchar,--随机试题id组合字符串
answers varchar,--用户考试随机试题答案字符串
score int,--成绩
);
